...
\textoResumo{
	As abordagens utilizadas nos sistemas de votações eletrônicas baseiam sua
segurança no fato de ter que confiar a entidade central que controla o sistema.
...
\begin{table}[h]
  \begin{tabular}{|>{\bfseries}l|p{6.57cm}|}
    ...
    Área de Concentração    & Arquitetura de Sistemas de Computação      \\ \hline
  \end{tabular}
\end{table}
